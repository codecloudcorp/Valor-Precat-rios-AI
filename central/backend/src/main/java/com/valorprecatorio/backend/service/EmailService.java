...
public class EmailService {
    ...
    public void enviarNotificacaoProposta(String nome, String telefone, String valor, String emailCliente, String mensagemCliente) {
        try {
            ...
            String valorFinal = (valor != null && !valor.isBlank()) ? valor : "Não informado";
            String msgFinal = (mensagemCliente != null && !mensagemCliente.isBlank()) ? mensagemCliente : "Nenhuma observação";
            ...
            String corpo = String.format("""
                ...
                """, nome, telefone, emailCliente, valorFinal, msgFinal);
    ...
    public void enviarNotificacaoParceiro(String nome, String telefone, String email, String cpfCnpj, 
        ...
        try {
            ...
            String corpo = String.format("""
                ...
                ================================================
                Acesse o painel para validar este parceiro.
